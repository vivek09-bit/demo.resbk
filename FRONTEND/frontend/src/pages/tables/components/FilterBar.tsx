            ...
            <div className="flex items-center gap-2">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-4 py-2.5 bg-white border border-dark-border
                                   rounded-xl text-sm text-text-primary placeholder-text-disabled
                                   focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 focus:outline-none transition-all"
                    />
                    {localSearch && (
                        <button
                ...
                <button
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-xl
                               bg-white border border-dark-border
                ...
                <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-full border transition-all duration-200
                        ${!isAnyFilterActive
                            ...
                            : 'bg-white border-dark-border text-text-tertiary hover:border-primary-500 hover:text-text-primary'
                        }`}
                >
                    All
                </button>
