                    ...
                    {!isLoggedIn && (
                        <ul className="flex items-center gap-8 text-sm">
                            ...
                            <li>
                                <Link
                                    to="/nearby"
                                    className={`block py-2.5 text-sm md:text-base transition-colors
                                                hover:text-primary-500 rounded-lg md:rounded-none md:py-0
                                                ${location.pathname === '/nearby' ? 'text-primary-500 font-semibold' : 'text-text-secondary'}`}
                                >
                                    Nearby
                                </Link>
                            </li>
                            ...
                            <ul className="flex flex-col gap-1">
                                ...
                                <li>
                                    <Link
                                        to="/nearby"
                                        onClick={() => setIsMenuOpen(false)}
                                        className={`block py-2.5 text-sm transition-colors hover:text-primary-500
                                                    rounded-lg ${location.pathname === '/nearby' ? 'text-primary-500 font-semibold' : 'text-text-secondary'}`}
                                    >
                                        Nearby Restaurants
                                    </Link>
                                </li>
