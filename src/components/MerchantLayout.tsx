...
import { IconDashboard, IconOrders, IconTables, IconMenu, IconProfile, IconLogout, IconHamburger } from './Icons'
// ─── Sidebar items ──────────────────────────────────────────────────────────
...
export default function MerchantLayout({ title, subtitle, children, headerActions }: MerchantLayoutProps) {
    ...
    return (
        <div className="h-screen bg-dark-bg text-text-primary flex flex-col">
            ...
            <div className={`flex-1 flex flex-col h-full ${sidebarOpen ? 'md:ml-56' : 'md:ml-16'} transition-all duration-300`}>
                {/* Header */}
