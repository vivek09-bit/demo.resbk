    ...
    return (
        <div
            ...
            className={`bg-dark-surface border border-dark-border border-l-4 ${borderColor}
                       ...
                       hover:-translate-y-1 hover:border-primary-500 hover:shadow-card
        ...
        >
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs text-text-tertiary mb-3">
                {table.seatedSince && (
                    <span className="inline-flex items-center gap-1 bg-dark-border/30 rounded-md px-2 py-1">
                ...
                {table.currentBill > 0 && (
                    <span className="inline-flex items-center gap-1 bg-dark-border/30 rounded-md px-2 py-1 font-medium text-text-primary">
